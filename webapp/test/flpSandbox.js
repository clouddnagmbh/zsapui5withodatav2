		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#atclouddnazsapui5withodatav2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"atclouddnazsapui5withodatav2-display": {
								"semanticObject": "atclouddnazsapui5withodatav2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=at.clouddna.zsapui5withodatav2",
									"url": sap.ui.require.toUrl("at/clouddna/zsapui5withodatav2")
								}
							}
						}
					}
